...
export const esmPatientChartSchema = {
  ...
  tileDefinitions: {
    _type: Type.Array,
    _description: 'Configuration for clinical summary tiles',
    _default: [
      {
        tileHeader: 'Test Clinical Summary',
        columns: [
          {
            id: 'weight',
            title: 'Weight',
            concept: '5089AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', // Weight concept UUID
            encounterType: '67a71486-1a54-468f-ac3e-7091a9a79584', // Adult Initial Encounter Type
            hasSummary: false,
          },
          {
            id: 'height',
            title: 'Height',
            concept: '5090AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', // Height concept UUID
            encounterType: '67a71486-1a54-468f-ac3e-7091a9a79584', // Adult Initial Encounter Type
            hasSummary: false,
          },
        ],
    ...
    _elements: {
      _type: Type.Object,
      _elements: {
        tileHeader: { _type: Type.String },
        columns: {
          _type: Type.Array,
          _elements: {
            _type: Type.Object,
            _elements: {
              id: { _type: Type.String },
              title: { _type: Type.String },
              concept: { _type: Type.ConceptUuid },
              encounterType: { _type: Type.UUID },
              hasSummary: { _type: Type.Boolean, _default: false },
            },
          },
        },
      },
